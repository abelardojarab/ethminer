...
public:
    ...
    static const OCLKernelName c_defaultKernelName = OCLKernelName::Fpga;

    OCLMiner(FarmFace& _farm, unsigned _index);
    ~OCLMiner() override;
    ...
    static void setCLKernel(unsigned /*unused*/) { s_clKernelName = OCLKernelName::Fpga; }
protected:
